    ...
    <footer className='w-full bg-[#E7EBEE] border-t border-border'>
      <div className='w-full max-w-[1440px] mx-auto px-6 py-10 flex flex-col justify-center items-start gap-10'>
          ...
          <div className='flex flex-col gap-3'>
            ...
            <div className='flex flex-col gap-2'>
              <Link
                ...
                className='border border-foreground rounded-md px-3 py-1.5 flex items-center gap-2 hover:bg-gray-50 transition-colors w-fit'
              >
                <Image
              ...
              <form className='flex gap-2'>
                <div className='flex-1 relative'>
                  ...
                  <input
                    type='email'
                    placeholder='E-mail'
                    className='w-full pl-9 pr-3 py-2 border border-border rounded-md text-xs focus:outline-none focus:ring-1 focus:ring-ring bg-white'
                  />
                </div>
                <button
                  type='submit'
                  className='px-4 py-2 bg-white border border-border rounded-md text-xs font-medium hover:bg-gray-50 transition-colors whitespace-nowrap'
                >
                  Enviar
                </button>
              </form>
        ...
        <div className='w-full pt-5 text-center'>
          <div className='flex flex-wrap justify-center items-center gap-2 text-[10px] text-muted mb-2'>
            {[
